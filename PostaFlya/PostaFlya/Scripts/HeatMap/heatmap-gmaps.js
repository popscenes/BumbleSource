...
HeatmapOverlay.prototype.setDataSet = function(data) {
    ...
    while (dlen--) {
        var latlng = new google.maps.LatLng(d[dlen].Latitude, d[dlen].Longitude);
        this.latlngs.push({ latlng: latlng, c: d[dlen].Weight });
        var point = this.pixelTransform(projection.fromLatLngToDivPixel(latlng));
        mapdata.data.push({ x: point.x, y: point.y, count: d[dlen].Weight });
    }
    this.heatmap.clear();
