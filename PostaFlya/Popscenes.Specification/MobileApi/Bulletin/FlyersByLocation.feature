...
Scenario: Mobile Api flyers by location with valid location returns all fliers within specified distance
	Given There are flyers around the geolocation <Latitude>, <Longitude>
	...
	And The content should contain a list of 30 flyers within <10> kilometers of <Latitude>, <Longitude>
