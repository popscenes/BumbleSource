...
namespace PostaFlya.Specification.Behaviour.TaskJob
{
    ...
    public partial class BiddingOnATaskFeature
    {
        ...
        public virtual void NavigateToTaskJobBid()
        {
            ...
            testRunner.Given("there is a flier with TASKJOB behaviour");
            testRunner.Then("I should be able to navigate to the BID page for that TASKJOB");
        ...
        public virtual void TaskJobBid()
        {
            ...
            this.ScenarioSetup(scenarioInfo);
            testRunner.Given("I have navigated to the BID page for a TASKJOB");
            testRunner.When("I place a TASKBID on the TASKJOB");
            testRunner.Then("the TASKBID will be registered against the TASKJOB");
            this.ScenarioCleanup();
        }
    }
}
