...
Scenario: update personal details
	...
	When I update my profile details with the following data:
	  | Name | FirstName | MiddleNames | Surname  | Email          | Address                      | Avatar                               | AddressPublic |
	  | User | FirstName | M           | LastName | user@email.com | -37.769:144.979:waihi avenue | 8F68AE77-0F61-4BFD-92AC-BFCA1CC5B9E2 | True          |
