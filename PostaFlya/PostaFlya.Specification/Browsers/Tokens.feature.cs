...
namespace PostaFlya.Specification.Browsers
{
    ...
    [NUnit.Framework.DescriptionAttribute("Token managment")]
    public partial class TokenManagmentFeature
    {
        ...
        [NUnit.Framework.DescriptionAttribute("Access Token Show external Token Status")]
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Access Token Request Token for a Source")]
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Access Token Obtain for a Source")]
