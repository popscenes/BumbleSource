...
namespace PostaFlya.Specification.Fliers
{
    ...
    public partial class FlierImportFeature
    {
        ...
        public virtual void ImportFlierWithInvalidAccessToken()
        {
            ...
            testRunner.Then("Then i will be prompted to obtain a valid token");
        ...
        [MbUnit.Framework.TestAttribute()]
        [MbUnit.Framework.DescriptionAttribute("Import Flier Obtain valid Access Token")]
        public virtual void ImportFlierObtainValidAccessToken()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Import Flier Obtain valid Access Token", ((string[])(null)));
            this.ScenarioSetup(scenarioInfo);
            testRunner.Given("I am a BROWSER in PARTICIPANT ROLE");
            testRunner.And("I do not have a valid acces token to import fliers");
            testRunner.When("I obtain a valid token from the source");
            testRunner.Then("Then i will be redircted back to the flier import page");
